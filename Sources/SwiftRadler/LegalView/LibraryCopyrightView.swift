...
public struct LibraryCopyrightView: View {
   ...
   private static func licenseTextView(library: LibraryCopyright) -> some View {
      ScrollView {
         ...
         Text(library.license.readLicenseText(for: library.index))
            .padding([.leading, .trailing, .bottom])
      }
...
struct SwiftUIView_Previews: PreviewProvider {
   static let libraries = [
      LibraryCopyright(index: 0, name: "Test Lib 1", shortName: "TL1", version: "1.1.1", license: .mit, copyright: "Copyright (c) Blub GmbH.", url: "https://www.goggle.de"),
      LibraryCopyright(index: 1, name: "Super Lib", shortName: nil, version: "4.4.2", license: .mit, copyright: "Copyright (c) Blub Corporation.", url: "https://www.goggle.de")
   ]
